...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>Saphie's Tasty | Homemade Food & Catering in Kampala</title>
        <meta name="description" content="Saphie's Tasty offers homemade catering, food delivery and snack packs in Kampala, Uganda. Authentic family-style cooking for events, parties and everyday meals." />
        <meta name="keywords" content="catering Kampala, food delivery Uganda, homemade food Kampala, event catering Uganda, snack packs Kampala, chapati delivery, Saphie's Tasty" />
        <meta property="og:title" content="Saphie's Tasty | Homemade Food & Catering in Kampala" />
        <meta property="og:description" content="Homemade catering, food delivery & snack packs in Kampala. Family-style cooking for every occasion." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/logo.png" />
        <link rel="canonical" href="https://saphiestasty.com" />
      </Helmet>
          ...
          <div className="relative z-10 container mx-auto px-4 text-center py-32">
            ...
            >
              ...
              <p className="font-body text-lg md:text-xl text-primary-foreground/70 max-w-2xl mx-auto mb-10">
                ...
                Catering, delivery & snack packs for every occasion in Kampala, Uganda.
              </p>
